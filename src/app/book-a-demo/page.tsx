  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: '500px',
        height: '500px',
        background: 'radial-gradient(circle, rgba(14, 181, 187, 0.1) 0%, transparent 70%)',
        filter: 'blur(70px)',
        pointerEvents: 'none',
        zIndex: 1
      }} />
      ...
      {/* Main Page Area hosting the Card */}
      <main style={{
        position: 'relative',
        zIndex: 2,
        flex: 1,
            ...
            <div>
              ...
              <form onSubmit={handleNextToCalendar} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }} className="contact-form-row">
                  ...
                  <div>
                    <label htmlFor="booking-lname-page" style={{ display: 'block', fontSize: '11px', color: 'rgba(255, 255, 255, 0.4)', marginBottom: '5px', fontWeight: 600 }}>Last Name *</label>
                    <input 
                      id="booking-lname-page"
                      type="text" 
                      required
                      placeholder="Doe"
                      value={lastName}
                ...
                <div>
                  <label htmlFor="booking-email-page" style={{ display: 'block', fontSize: '11px', color: 'rgba(255, 255, 255, 0.4)', marginBottom: '5px', fontWeight: 600 }}>
                    Work Email *
                  </label>
                  <input 
                    id="booking-email-page"
                    type="email" 
                    required
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1.5fr', gap: '12px' }} className="contact-form-row">
                            ...
                            {filteredCountries.map((c) => (
                              ...
                              >
                                <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                                  ...
                                  />
                                  <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '140px' }}>{c.name}</span>
                                </span>
                  ...
                  {/* Phone Number Input */}
                  <div>
                    <label htmlFor="booking-phone-page" style={{ display: 'block', fontSize: '11px', color: 'rgba(255, 255, 255, 0.4)', marginBottom: '5px', fontWeight: 600 }}>Phone Number *</label>
                    <input 
                      id="booking-phone-page"
                      type="tel" 
                      required
                ...
                <div>
                  <label htmlFor="booking-size-page" style={{ display: 'block', fontSize: '11px', color: 'rgba(255, 255, 255, 0.4)', marginBottom: '5px', fontWeight: 600 }}>Employee Size *</label>
                  <select 
                    id="booking-size-page"
                    value={employeeSize}
            ...
            <div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  {/* Timezone Selector */}
                  <div>
                    <label htmlFor="booking-timezone-page" style={{ display: 'block', fontSize: '11px', color: 'rgba(255, 255, 255, 0.4)', marginBottom: '6px', fontWeight: 600 }}>
                      Timezone
                    </label>
                    <select
                      id="booking-timezone-page"
                      value={timezone}
