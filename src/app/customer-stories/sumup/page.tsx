...
export default function SumUpCaseStudy() {
  ...
  const renderChallengeVisual = () => (
    <div className="scs-visual-illustration">
      <div className="scs-illustration-card red">
        ...
        <p>Before 360Airo, reps spent close to four hours a day researching fintech decision-makers working through directories to find people worth contacting.</p>
      </div>
      <div className="scs-illustration-card red">
  ...
  const renderSolutionVisual = () => (
    <div className="scs-visual-illustration">
      <div className="scs-illustration-card purple">
        ...
        <p>Instead of reps hand-searching for buyers, the platform identified qualified fintech decision-makers automatically and queued them for outreach.</p>
      </div>
      <div className="scs-illustration-card purple">
        <span className="scs-card-number">02</span>
      ...
      <div className="scs-ic-content-container" style={{ background: '#FFFFFF', padding: '24px', borderRadius: '12px', border: '1px solid #E5E5E5', boxShadow: '0 4px 12px rgba(0,0,0,0.02)' }}>
        <div className={`scs-ic-view ${compareView === 'before' ? 'active' : ''}`}>
          <ul className="scs-ic-before-list" style={{ gap: '16px' }}>
            <li><span>Sales reps manually searched for fintech decision-makers</span></li>
        ...
        <div className={`scs-ic-view ${compareView === 'after' ? 'active' : ''}`}>
          <ul className="scs-ic-after-list" style={{ gap: '16px' }}>
            <li><Check size={18} className="scs-ic-check" /> <span>AI automatically identified qualified fintech buyers</span></li>
        ...
        <div className="cs-featured-artisan-grid" style={{ padding: '0 24px' }}>
          <div className="cs-featured-artisan-content">
            <div className="cs-featured-artisan-header">
              ...
              <h2>How SumUp sent 400,000+ personalized emails with 360Airo</h2>
              <p className="cs-featured-quote">
                “SumUp achieved unprecedented scale in their global outreach campaigns.”
              </p>
            </div>
            ...
            <div className="cs-featured-artisan-stats">
              ...
              <div className="cs-featured-stat">
                <h4>60%</h4>
                <p>Increase in open rates</p>
              </div>
            </div>
          </div>

          <div className="cs-featured-artisan-image">
            <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="SumUp" width="600" height="600" loading="eager" decoding="async" />
            <div className="cs-featured-image-overlay">
              <p className="cs-featured-name">Michael Brown</p>
              <p className="cs-featured-title">Global Head of Sales at SumUp</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <article className="scs-article-content">
            ...
            <section id="introduction">
              ...
              <h3 style={{ fontSize: '36px', lineHeight: '1.2', marginBottom: '24px', fontWeight: 500, letterSpacing: '-0.02em', color: '#111827' }}>
                SumUp, a fintech company size 30, came to 360Airo with a familiar problem
              </h3>
            ...
            <section id="the-challenge">
              ...
              <p style={{marginBottom: '32px'}}>Manual workflows could not support both quality and volume at the same time. SumUp needed quality at scale, not just more volume.</p>
            ...
            <section id="outcome">
              ...
              <p>Thirty days in, SumUp had a different sales motion one where pipeline growth no longer depended on adding people, and qualified conversations were no longer a function of how many hours a rep could squeeze into research. The team kept its size and changed its output.</p>
        ...
        <aside className="scs-right-details-column">
          <div className="scs-sidebar-box" style={{ padding: '16px', borderRadius: '12px', display: 'flex', flexDirection: 'column', backgroundColor: '#FAF9F6' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', padding: '10px 0', borderBottom: '1px solid #E5E7EB' }}>
              ...
              <div style={{ fontSize: '15px', fontWeight: 500, color: '#111827' }}>SumUp</div>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', padding: '10px 0', borderBottom: '1px solid #E5E7EB' }}>
              <p style={{ fontSize: '11px', fontWeight: 500, color: '#6B7280', textTransform: 'uppercase', letterSpacing: '0.05em', margin: 0 }}>Industry</p>
              <div style={{ fontSize: '15px', fontWeight: 500, color: '#111827' }}>Fintech</div>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', paddingTop: '10px' }}>
              ...
              <div style={{ fontSize: '15px', fontWeight: 500, color: '#111827', display: 'flex', alignItems: 'center', gap: '8px' }}>
                <img src="https://hatscripts.github.io/circle-flags/flags/un.svg" alt="UN Flag" style={{ width: '18px', height: '18px', borderRadius: '50%', objectFit: 'cover' }} />
                Global
              </div>
            </div>
          </div>
          ...
          <div className="scs-sidebar-box" style={{ 
            ...
            <p style={{ fontSize: '11px', opacity: 0.85, margin: '0 0 12px 0', lineHeight: 1.4, color: 'rgba(255, 255, 255, 0.8)' }}>
              Hire the AI BDR that discovers qualified fintech leads and books meetings 24/7.
            </p>
