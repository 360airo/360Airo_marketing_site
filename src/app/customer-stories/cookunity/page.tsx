...
export default function CookUnityCaseStudy() {
  ...
  const renderChallengeVisual = () => (
    <div className="scs-visual-illustration">
      <div className="scs-illustration-card red">
        ...
        <p>Before 360Airo, reps spent close to four hours a day researching meal delivery service decision-makers working through directories to find people worth contacting.</p>
      </div>
      <div className="scs-illustration-card red">
  ...
  const renderSolutionVisual = () => (
    <div className="scs-visual-illustration">
      <div className="scs-illustration-card purple">
        ...
        <p>Instead of reps hand-searching for buyers, the platform identified qualified meal delivery service decision-makers automatically and queued them for outreach.</p>
      </div>
      <div className="scs-illustration-card purple">
        <span className="scs-card-number">02</span>
      ...
      <div className="scs-ic-content-container" style={{ background: '#FFFFFF', padding: '24px', borderRadius: '12px', border: '1px solid #E5E5E5', boxShadow: '0 4px 12px rgba(0,0,0,0.02)' }}>
        <div className={`scs-ic-view ${compareView === 'before' ? 'active' : ''}`}>
          <ul className="scs-ic-before-list" style={{ gap: '16px' }}>
            <li><span>Sales reps manually searched for meal delivery service decision-makers</span></li>
        ...
        <div className={`scs-ic-view ${compareView === 'after' ? 'active' : ''}`}>
          <ul className="scs-ic-after-list" style={{ gap: '16px' }}>
            <li><Check size={18} className="scs-ic-check" /> <span>AI automatically identified qualified meal delivery service buyers</span></li>
        ...
        <div className="cs-featured-artisan-grid" style={{ padding: '0 24px' }}>
          <div className="cs-featured-artisan-content">
            <div className="cs-featured-artisan-header">
              ...
              <h2>How CookUnity scaled personalized outbound with 360Airo</h2>
              <p className="cs-featured-quote">
                “CookUnity scaled their outreach without losing the personal touch.”
              </p>
            </div>
          ...
          <div className="cs-featured-artisan-image">
            <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32e7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="CookUnity" width="600" height="600" loading="eager" decoding="async" />
            <div className="cs-featured-image-overlay">
              <p className="cs-featured-name">Alice Johnson</p>
              <p className="cs-featured-title">Marketing Director at CookUnity</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="scs-right-scrollable-content">
          <article className="scs-article-content">
            ...
            <section id="the-challenge">
              ...
              <p style={{marginBottom: '32px'}}>Manual workflows could not support both quality and volume at the same time. CookUnity needed quality at scale, not just more volume.</p>
            ...
            <section id="outcome">
              ...
              <p>Thirty days in, CookUnity had a different sales motion one where pipeline growth no longer depended on adding people, and qualified conversations were no longer a function of how many hours a rep could squeeze into research. The team kept its size and changed its output.</p>
        ...
        <aside className="scs-right-details-column">
          <div className="scs-sidebar-box" style={{ padding: '16px', borderRadius: '12px', display: 'flex', flexDirection: 'column', backgroundColor: '#FAF9F6' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', padding: '10px 0', borderBottom: '1px solid #E5E7EB' }}>
              ...
              <div style={{ fontSize: '15px', fontWeight: 500, color: '#111827' }}>CookUnity</div>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', padding: '10px 0', borderBottom: '1px solid #E5E7EB' }}>
              <p style={{ fontSize: '11px', fontWeight: 500, color: '#6B7280', textTransform: 'uppercase', letterSpacing: '0.05em', margin: 0 }}>Industry</p>
              <div style={{ fontSize: '15px', fontWeight: 500, color: '#111827' }}>Meal Delivery</div>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', paddingTop: '10px' }}>
              ...
              <div style={{ fontSize: '15px', fontWeight: 500, color: '#111827', display: 'flex', alignItems: 'center', gap: '8px' }}>
                <img src="https://hatscripts.github.io/circle-flags/flags/us.svg" alt="USA Flag" style={{ width: '18px', height: '18px', borderRadius: '50%', objectFit: 'cover' }} />
                USA
              </div>
            </div>
          </div>
          ...
          <div className="scs-sidebar-box" style={{ 
            ...
            <p style={{ fontSize: '11px', opacity: 0.85, margin: '0 0 12px 0', lineHeight: 1.4, color: 'rgba(255, 255, 255, 0.8)' }}>
              Hire the AI BDR that discovers qualified food & beverage leads and books meetings 24/7.
            </p>
