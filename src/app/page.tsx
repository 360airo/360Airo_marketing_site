...
export default function App() {
  ...
  <div id="section-wyg"><section className="ws"><div className="wh"><div className="wl"><p className="we">Automate your outreach with intelligence — or run it yourself.</p><h1 className="whl"><span>WHAT </span><span>YOU </span><span>GET</span></h1><div className="wc"><button className="wbd">We're Ready, are You? <svg width={16} height={16} viewBox="0 0 16 16" fill="none"><path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg></button><button className="wbg">Learn More</button></div></div><div className="wr"><div className="wf"><div className="wft"><div className="wfn">01 — Intelligence</div><h3 className="wfh">An Intelligence with a human brain</h3><p className="wfd">Humanized automated outreach that reads, adapts, responds like a real person.</p></div><div className="wfg"><svg className="wm" viewBox="0 0 340 220" fill="none"><rect width={340} height={220} rx={20} fill="#1A1E26" /><circle cx={24} cy={20} r={5} fill="#4ADE80" opacity=".8" /><rect x={36} y={16} width={64} height={8} rx={4} fill="#2D3340" /><line x1={16} y1={36} x2={324} y2={36} stroke="#2D3340" /><rect x={120} y={48} width={204} height={40} rx={12} fill="#2D5F8A" /><text x={134} y={63} fontFamily="sans-serif" fontSize="9.5" fill="#fff">Hey Sarah — noticed your team just</text><text x={134} y={77} fontFamily="sans-serif" fontSize="9.5" fill="#fff">closed a Series B. Congrats!</text><rect x={16} y={106} width={180} height={32} rx={12} fill="#2D3340" /><text x={30} y={126} fontFamily="sans-serif" fontSize="9.5" fill="#C8C8C0">Thanks! How did you hear?</text><rect x={140} y={150} width={184} height={40} rx={12} fill="#2D5F8A" /><text x={154} y={165} fontFamily="sans-serif" fontSize="9.5" fill="#fff">Saw the TechCrunch piece — would</text><text x={154} y={179} fontFamily="sans-serif" fontSize="9.5" fill="#fff">love to chat about scaling ops.</text><rect x={16} y={196} width={56} height={16} rx={8} fill="rgba(74,222,128,.12)" /><text x={24} y={207} fontFamily="sans-serif" fontSize="7.5" fill="#4ADE80" fontWeight={600}>AI Drafted</text></svg></div></div><div className="wf"><div className="wft"><div className="wfn">02 — Freedom</div><h3 className="wfh">Unlimited Freedom</h3><p className="wfd">User-friendly web app — easy to monitor, track, full pipeline control.</p></div><div className="wfg"><svg className="wm" viewBox="0 0 340 220" fill="none"><rect width={340} height={220} rx={20} fill="#1A1E26" /><text x={20} y={26} fontFamily="sans-serif" fontSize={11} fill="#fff" fontWeight={700}>Campaign Results</text><rect x={16} y={40} width={100} height={56} rx={10} fill="#232830" /><text x={24} y={78} fontFamily="sans-serif" fontSize={22} fill="#fff" fontWeight={800}>2,847</text><rect x={120} y={40} width={100} height={56} rx={10} fill="#232830" /><text x={128} y={78} fontFamily="sans-serif" fontSize={22} fill="#fff" fontWeight={800}>1,263</text><rect x={224} y={40} width={100} height={56} rx={10} fill="#232830" /><text x={232} y={78} fontFamily="sans-serif" fontSize={22} fill="#fff" fontWeight={800}>934</text><text x={20} y={140} fontFamily="sans-serif" fontSize={28} fill="#fff" fontWeight={800}>1,592</text><path d="M20 200 Q100 180,180 155 Q260 128,320 110" stroke="#4ADE80" strokeWidth={2} fill="none" /><path d="M20 200 Q120 186,220 165 Q300 142,320 136" stroke="#60A5FA" strokeWidth={2} fill="none" /></svg></div></div><div className="wf"><div className="wft"><div className="wfn">03 — Efficiency</div><h3 className="wfh">Cost and Time efficiency</h3><p className="wfd">Save cost and precious time to push your business ahead.</p></div><div className="wfg"><svg className="wm" viewBox="0 0 340 220" fill="none"><rect width={340} height={220} rx={20} fill="#1A1E26" /><text x={20} y={28} fontFamily="sans-serif" fontSize={11} fill="#fff" fontWeight={700}>Efficiency Overview</text><rect x={16} y={42} width={152} height={72} rx={14} fill="#232830" /><text x={28} y={92} fontFamily="sans-serif" fontSize={34} fill="#4ADE80" fontWeight={800}>127h</text><rect x={176} y={42} width={148} height={72} rx={14} fill="#232830" /><text x={188} y={92} fontFamily="sans-serif" fontSize={34} fill="#60A5FA" fontWeight={800}>73%</text><rect x={20} y={142} width={280} height={10} rx={5} fill="#5A5A56" opacity=".5" /><rect x={20} y={178} width={82} height={10} rx={5} fill="#4ADE80" /><text x={108} y={186} fontFamily="sans-serif" fontSize={7} fill="#4ADE80" fontWeight={600}>11h — 4x faster</text></svg></div></div></div></div></section></div>
  <div id="section-dashboard"><section className="ds"><div className="dh"><div className="dtag" data-anim="up"><svg width={14} height={14} viewBox="0 0 24 24" fill="none" stroke="#3B82F6" strokeWidth={2}><path d="M3 3v18h18" /><path d="M18 9l-5 5-2-2-4 4" /></svg> LIVE DASHBOARD</div><h2 data-anim="up">Track and optimize your sales outreach</h2><p data-anim="up">Monitor outreach performance, engagement trends, and deal progression — all in real time.</p></div><div className="dm" data-anim="scale"><div className="dc"><div className="dtop"><div className="dtl"><div className="ddot" /><h3>360Airo Dashboard</h3></div><div className="dtr"><div className="dper">Last 30 days</div><div className="dst"><svg width={12} height={12} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12l5 5L20 7" /></svg> All systems active</div></div></div><div className="dkpis" id="dkpis"><div className="dkpi"><div className="dkt"><span className="dkl">Emails Sent</span><span className="dkb up">Γåæ 24.3%</span></div><div className="dkv" style={{color: '#3B82F6'}} data-to={4286} data-suffix>0</div><svg className="dsp" width={120} height={28} viewBox="0 0 120 28" fill="none"><path className="dsl" d="M2 22L15 18L28 20L42 14L56 16L70 10L84 12L98 6L112 4L118 3" stroke="#3B82F6" strokeWidth="1.5" fill="none" strokeLinecap="round" /><path className="dsa" d="M2 22L15 18L28 20L42 14L56 16L70 10L84 12L98 6L112 4L118 3V28H2Z" fill="url(#x1)" /><defs><linearGradient id="x1" x1={0} y1={0} x2={0} y2={1}><stop stopColor="#3B82F6" /><stop offset={1} stopColor="#3B82F6" stopOpacity={0} /></linearGradient></defs></svg></div><div className="dkpi"><div className="dkt"><span className="dkl">Leads Generated</span><span className="dkb up">Γåæ 18.7%</span></div><div className="dkv" style={{color: '#8B5CF6'}} data-to={1208} data-suffix>0</div><svg className="dsp" width={120} height={28} viewBox="0 0 120 28" fill="none"><path className="dsl" d="M2 24L18 20L34 22L50 15L66 17L82 11L98 8L114 5L118 4" stroke="#8B5CF6" strokeWidth="1.5" fill="none" strokeLinecap="round" /><path className="dsa" d="M2 24L18 20L34 22L50 15L66 17L82 11L98 8L114 5L118 4V28H2Z" fill="url(#x2)" /><defs><linearGradient id="x2" x1={0} y1={0} x2={0} y2={1}><stop stopColor="#8B5CF6" /><stop offset={1} stopColor="#8B5CF6" stopOpacity={0} /></linearGradient></defs></svg></div><div className="dkpi"><div className="dkt"><span className="dkl">Meetings Booked</span><span className="dkb hot">+31</span></div><div className="dkv" style={{color: '#06B6D4'}} data-to={176} data-suffix>0</div><svg className="dsp" width={120} height={28} viewBox="0 0 120 28" fill="none"><path className="dsl" d="M2 20L20 22L38 17L54 19L70 12L86 14L102 7L118 5" stroke="#06B6D4" strokeWidth="1.5" fill="none" strokeLinecap="round" /><path className="dsa" d="M2 20L20 22L38 17L54 19L70 12L86 14L102 7L118 5V28H2Z" fill="url(#x3)" /><defs><linearGradient id="x3" x1={0} y1={0} x2={0} y2={1}><stop stopColor="#06B6D4" /><stop offset={1} stopColor="#06B6D4" stopOpacity={0} /></linearGradient></defs></svg></div><div className="dkpi"><div className="dkt"><span className="dkl">Reply Rate</span><span className="dkb up">Γåæ 6.2%</span></div><div className="dkv" style={{color: '#16a34a'}} data-to="34.2" data-suffix="%">0</div><svg className="dsp" width={120} height={28} viewBox="0 0 120 28" fill="none"><path className="dsl" d="M2 22L16 19L30 21L44 16L58 18L72 13L86 14L100 9L114 6L118 5" stroke="#16a34a" strokeWidth="1.5" fill="none" strokeLinecap="round" /><path className="dsa" d="M2 22L16 19L30 21L44 16L58 18L72 13L86 14L100 9L114 6L118 5V28H2Z" fill="url(#x4)" /><defs><linearGradient id="x4" x1={0} y1={0} x2={0} y2={1}><stop stopColor="#16a34a" /><stop offset={1} stopColor="#16a34a" stopOpacity={0} /></linearGradient></defs></svg></div></div><div className="dcharts"><div className="dcp"><div className="dcph"><h4>Outreach Performance</h4><div className="dcl"><div className="dcli"><div className="dcld" style={{background: '#3B82F6'}} />Emails</div><div className="dcli"><div className="dcld" style={{background: '#8B5CF6'}} />LinkedIn</div><div className="dcli"><div className="dcld" style={{background: '#06B6D4'}} />Calls</div></div></div><svg className="dcsv" id="dlc" viewBox="0 0 520 190" fill="none"><defs><linearGradient id="gb" x1={0} y1={0} x2={0} y2={1}><stop stopColor="#3B82F6" stopOpacity=".12" /><stop offset={1} stopColor="#3B82F6" stopOpacity={0} /></linearGradient><linearGradient id="gv" x1={0} y1={0} x2={0} y2={1}><stop stopColor="#8B5CF6" stopOpacity=".08" /><stop offset={1} stopColor="#8B5CF6" stopOpacity={0} /></linearGradient><linearGradient id="gc" x1={0} y1={0} x2={0} y2={1}><stop stopColor="#06B6D4" stopOpacity=".06" /><stop offset={1} stopColor="#06B6D4" stopOpacity={0} /></linearGradient></defs><line x1={44} y1={160} x2={508} y2={160} stroke="rgba(255,255,255,.06)" /><path className="dma" d="M76 142C100 138 148 122 220 94C292 70 364 44 496 16L496 160H76Z" fill="url(#gb)" /><path className="dml" d="M76 142C100 138 148 122 220 94C292 70 364 44 496 16" stroke="#3B82F6" strokeWidth={2} strokeLinecap="round" fill="none" /><path className="dma" d="M76 150C148 136 220 116 292 95C364 73 436 50 496 38L496 160H76Z" fill="url(#gv)" /><path className="dml" d="M76 150C148 136 220 116 292 95C364 73 436 50 496 38" stroke="#8B5CF6" strokeWidth={2} strokeLinecap="round" fill="none" /><path className="dma" d="M76 156C148 148 220 134 292 118C364 100 436 82 496 70L496 160H76Z" fill="url(#gc)" /><path className="dml" d="M76 156C148 148 220 134 292 118C364 100 436 82 496 70" stroke="#06B6D4" strokeWidth={2} strokeLinecap="round" fill="none" /><circle className="dmd" cx={496} cy={16} r="3.5" fill="#3B82F6" /><circle className="dmd" cx={496} cy={38} r={3} fill="#8B5CF6" /><circle className="dmd" cx={496} cy={70} r="2.5" fill="#06B6D4" /></svg></div><div className="dcp"><div className="dcph"><h4>Channel Split</h4></div><div style={{display: 'flex', alignItems: 'center', gap: 24, marginBottom: 20}}><svg className="ddw" id="ddc" width={120} height={120} viewBox="0 0 120 120"><circle cx={60} cy={60} r={48} fill="none" stroke="rgba(255,255,255,.06)" strokeWidth={12} /><circle className="dds s1" cx={60} cy={60} r={48} fill="none" stroke="#3B82F6" strokeWidth={12} strokeDasharray="166 136" strokeLinecap="round" /><circle className="dds s2" cx={60} cy={60} r={48} fill="none" stroke="#8B5CF6" strokeWidth={12} strokeDasharray="90.5 211.5" strokeLinecap="round" /><circle className="dds s3" cx={60} cy={60} r={48} fill="none" stroke="#06B6D4" strokeWidth={12} strokeDasharray="45.3 256.7" strokeLinecap="round" /><text x={60} y={55} fontFamily="sans-serif" fontSize={20} fontWeight={800} fill="#fff" textAnchor="middle" id="ddv">0</text><text x={60} y={70} fontFamily="sans-serif" fontSize={9} fill="rgba(255,255,255,.45)" textAnchor="middle">Total Sent</text></svg><div style={{display: 'flex', flexDirection: 'column', gap: 10, flex: 1}}><div style={{display: 'flex', justifyContent: 'space-between'}}><span style={{fontSize: 12, color: 'rgba(255,255,255,.45)'}}>Email</span><span style={{fontWeight: 700, fontSize: 13, color: '#3B82F6'}}>55%</span></div><div style={{display: 'flex', justifyContent: 'space-between'}}><span style={{fontSize: 12, color: 'rgba(255,255,255,.45)'}}>LinkedIn</span><span style={{fontWeight: 700, fontSize: 13, color: '#8B5CF6'}}>30%</span></div><div style={{display: 'flex', justifyContent: 'space-between'}}><span style={{fontSize: 12, color: 'rgba(255,255,255,.45)'}}>Calls</span><span style={{fontWeight: 700, fontSize: 13, color: '#06B6D4'}}>15%</span></div></div></div><div style={{background: 'rgba(255,255,255,.03)', borderRadius: 10, padding: 14, border: '1px solid rgba(255,255,255,.06)'}}><div style={{display: 'flex', justifyContent: 'space-between', marginBottom: 8}}><span style={{fontSize: 11, color: 'rgba(255,255,255,.45)'}}>Avg. Reply Rate</span><span style={{fontWeight: 700, fontSize: 13, color: '#16a34a'}}>34.2%</span></div><div style={{height: 6, background: 'rgba(255,255,255,.06)', borderRadius: 3, overflow: 'hidden'}}><div className="drf" id="drb" style={{background: 'linear-gradient(90deg,#16a34a,#06B6D4)'}} /></div></div></div></div><div className="dbot"><div className="dbp" id="dap"><div className="dbpt">Recent Activity<span className="dlv">Live</span></div><div className="dar"><div className="dai dag">≡ƒÆ¼</div><div className="dat"><p>Sarah Chen replied to your outreach</p><span>2 min ago</span></div><div className="daval" style={{color: '#16a34a'}}>Hot</div></div><div className="dar"><div className="dai dab">≡ƒôà</div><div className="dat"><p>Meeting booked with Acme Corp</p><span>12 min ago</span></div><div className="daval" style={{color: '#3B82F6'}}>New</div></div><div className="dar"><div className="dai dav">≡ƒñû</div><div className="dat"><p>AI sequence completed — 89 prospects</p><span>28 min ago</span></div><div className="daval" style={{color: '#8B5CF6'}}>Done</div></div><div className="dar"><div className="dai daa">≡ƒôè</div><div className="dat"><p>New pipeline loaded — Enterprise Tech</p><span>1h ago</span></div><div className="daval" style={{color: '#d97706'}}>204</div></div></div><div className="dbp" id="dbap"><div className="dbpt">Channel Performance<span>This month</span></div><div className="dcr"><span className="dcrl">Email</span><div className="dcrt"><div className="dcrf" data-w="85%" style={{background: 'linear-gradient(90deg,#3B82F6,#60A5FA)'}} /></div><span className="dcrv" style={{color: '#3B82F6'}}>85%</span></div><div className="dcr"><span className="dcrl">LinkedIn</span><div className="dcrt"><div className="dcrf" data-w="72%" style={{background: 'linear-gradient(90deg,#8B5CF6,#A78BFA)'}} /></div><span className="dcrv" style={{color: '#8B5CF6'}}>72%</span></div><div className="dcr"><span className="dcrl">Calls</span><div className="dcrt"><div className="dcrf" data-w="58%" style={{background: 'linear-gradient(90deg,#06B6D4,#22D3EE)'}} /></div><span className="dcrv" style={{color: '#06B6D4'}}>58%</span></div><div className="dcr"><span className="dcrl">SMS</span><div className="dcrt"><div className="dcrf" data-w="41%" style={{background: 'linear-gradient(90deg,#FB923C,#FBBF24)'}} /></div><span className="dcrv" style={{color: '#ea580c'}}>41%</span></div><div className="dpm"><div><div style={{fontSize: 11, color: 'rgba(255,255,255,.45)'}}>Pipeline Value</div><div className="dpv" id="dpv">$0</div></div><div style={{textAlign: 'right'}}><div style={{fontSize: 10, color: '#16a34a', fontWeight: 600}}>Γåæ 42.8%</div><div style={{fontSize: 10, color: 'rgba(255,255,255,.45)'}}>vs last month</div></div></div></div></div></div></div></section></div>
